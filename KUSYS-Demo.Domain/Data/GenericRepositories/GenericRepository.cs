...
using KUSYS_Demo.Domain.Data.EntityFrameWork;
using KUSYS_Demo.Domain.Data.EntityFrameWork.Entities;
using Microsoft.EntityFrameworkCore;

namespace KUSYS_Demo.Domain.Data.GenericRepositories;
...
public class GenericRepository<T> where T : BaseEntity
{
    ...
    public virtual IQueryable<T> ListNt(Expression<Func<T, bool>> predicate)
    {
     ...
     /// <summary>
        ...
        /// <param name="setNewId"></param>
        public virtual void BulkInsert(List<T> entities, bool setNewId = true)
        {
            ...
            _dataContext.BulkInsert(entities, bulkConfig);
        }
        ...
        /// <param name="entities"></param>
        /// <param name="setNewId"></param>
        public virtual async Task BulkInsertAsync(List<T> entities, bool setNewId = true)
        {
            foreach (var entity in entities)
            {
                if (setNewId)
            ...
            await _dataContext.BulkInsertAsync(entities, bulkConfig);
        }
